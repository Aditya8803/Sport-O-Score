...
document.addEventListener('DOMContentLoaded',()=>{
    ...
    maxOvers = parseInt(localStorage.getItem('gameLimit'));
    ...
    sevenButton.addEventListener("click",function(){updateRuns(7)});
    ...
    declare.addEventListener("click",endInnings);
...
const showRuns = (e) =>{
    ...
    document.getElementById('declare').disabled = false
    enable();
...
const wideScored = () => {
    ...
    document.getElementById('declare').disabled = true
    timeline.push("Wd");
